...
//		//log.debugPrintCurrentMethodName();
		...
		try {
			...
			System.out.println("ParseException in  getStringToDate" + e.getMessage());
		}
...
//		//log.debugPrintCurrentMethodName();
		...
		try {
			...
			System.out.println(" Exception in changeDateFormat " + e.getMessage());
		}
...
//		//log.debugPrintCurrentMethodName();
	...
	public static final Date formatString(String dateInStr, int formatCode) {
		...
		try {
			...
			System.out.println("Exception in formatString" + e.getMessage());
		}
		return strdt;
	}
	...
	public static final Date formatAppointmentDate(String dateInStr) {
		...
		try {
			...
			System.out.println("Exception in formatAppointmentDate" + e.getMessage());
		}
		return strdt;
	}
	...
	public static long getDateDiffInDays(String fromDateStr, String toDateStr) {
		...
		try {
			...
			System.out.println("Exception in getDateDiffInDays" + e.getMessage());
		}
		return daysDiff;
	}
	...
	public static final String calcDateFromJulian(int daynumber) {
		...
		try {
			...
			System.out.println("IllegalArgumentException in calcDateFromJulian" + e.getMessage());
		} catch (Exception e) {
			System.out.println("Exception in calcDateFromJulian" + e.getMessage());
		}
	...
	public static Long getDaysBetweenDates(String dateFormat, String inputDate1, String inputDate2) {
		...
		try {
			...
			System.out.println("Exception in getDaysBetweenDates " + e.getMessage());
		}
		return numDays;
	}
	...
	public static Long getHoursDiff(String d1, String d2, String dateFormate) {
		...
		try {
			...
			System.out.println("Exception in getHoursDiff " + e.getMessage());
		}
	...
	public static boolean isFutureDate(String date) {
		...
		try {
			...
			System.out.println("ParseException in isFutureDate" + e.getMessage());
			return false;
		}
