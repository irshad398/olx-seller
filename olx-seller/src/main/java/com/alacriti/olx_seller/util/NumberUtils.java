...
//		log.debugPrintCurrentMethodName();
		try {
			...
			System.out.println("NumberFormatException in getDouble " + e.getMessage());
	...
	public static int getInt(String numStr) {
		...
		try {
			...
			System.out.println("NumberFormatException in getInt " + e.getMessage());
	...
	public static long getLong(String numStr) {
		...
		try {
			...
			System.out.println("NumberFormatException in getLong " + e.getMessage());
	...
	public static short getShort(String numStr) {
		...
		try {
			...
			System.out.println("NumberFormatException in getShort " + e.getMessage());
	...
	public static boolean isDecimal(String str) {
		...
		try {
			...
			System.out.println("NumberFormatException in isDecimal " + e.getMessage());
			return false;
		}
		return true;
	}
	...
	public static BigDecimal getBigdecimal(String stringNumber) {
		...
		try {
			...
			System.out.println("NumberFormatException in getBigdecimal " + e.getMessage());
